...
#pragma warning(pop) 
    ...
    WindowID _Window::get_window_id() const noexcept
    {
    ...
    void _Renderer::set_color(red_t r, green_t g, blue_t b, alpha_t a) noexcept
    {
    ...
    _Event_sub_system::_Event_sub_system()
    {
